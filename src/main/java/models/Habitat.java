...
public class Habitat {
    ...
    public void setCapacidadeMaximaAnimais(int capacidadeMaximaAnimais) { this.capacidadeMaximaAnimais = capacidadeMaximaAnimais; }
    
    public List<Animal> getAnimais() { return animais; }
    public void setAnimais(List<Animal> animais) { this.animais = animais; }
    
    public boolean isPublicoAcessivel() { return publicoAcessivel; }
    public void setPublicoAcessivel(boolean publicoAcessivel) { this.publicoAcessivel = publicoAcessivel; }
